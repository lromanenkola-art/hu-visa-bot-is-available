    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if outcome == "no_slots":
                ...
                page.wait_for_timeout(500)
                # Скриншот именно видимой области (не всей страницы) -
                # Bootstrap-модалка использует position:fixed и может не
                # попадать в full-page скриншот при склейке длинной страницы
